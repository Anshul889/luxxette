...
import { addAddressTwo } from "../userActions";
...
class UserAddressFormTwo extends Component {
  handleAddressSubmit = async values => {
    this.props.addAddressTwo(values);
    this.props.reset();
...
export default withFirestore(
  connect(
    ...
    reduxForm({ form: 'addAddressTwo', destroyOnUnmount:false, validate })(
      UserAddressFormTwo
    )
  )
);
