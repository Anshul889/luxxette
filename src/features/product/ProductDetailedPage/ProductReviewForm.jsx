...
const validate = combineValidators({
  rating: composeValidators(isRequired('rating'))(),
      ...
      authenticated && (
        <div>
          ...
          <Form
            ...
            onSubmit={this.props.handleSubmit(this.handleReviewSubmit)}
          >
            <div style={{ marginBottom: '10px' }}>
              <span>Please select a rating</span>
              <div style={{ transform: 'translateY(2px)', display:'inline-block', marginLeft: '5px' }}>
                <Field
                  name='rating'
                  type='text'
            ...
            <Button
              ...
              content={isReviewer ? 'Edit Review' : 'Add Review'}
              labelPosition='left'
              icon='edit'
            />
          </Form>
