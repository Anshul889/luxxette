    ...
    if (products.length === 0) {
      return (
        <div className={styles.jewellery}>
          <h1 className={styles.heading}>Tops</h1>
    ...
    return (
      <div className={styles.jewellery}>
        ...
        <div className={styles.filter}>
            <Button color={'black'} active={sortedByPrice==='lowestPrice'} onClick={this.filterAsc}>Lowest Price</Button>
            <Button  color={'black'} active={sortedByPrice ==='highestPrice'} onClick={this.filterDsc}>Highest Price</Button>
            {(sortedByName ==='ZtoA') && <Button  color={'black'} onClick={this.filterNameDsc}>Name</Button>}
            {(sortedByName === '' || sortedByName ==='AtoZ') && <Button  color={'black'} onClick={this.filterNameAsc}>Name</Button>}
            </div>
        <div className={styles.container}>
